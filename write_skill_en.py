#!/usr/bin/env python3
"""Write knowpitch SKILL.en.md (English version)."""
...
file_path = r"C:\Users\iyaba\DoubaoWork\chats\2026-08-29\new-chat\knowpitch\skills\knowpitch\SKILL.en.md"
...
with open(file_path, "rb") as f:
    first = f.read(10)
print(f"First 10 bytes: {list(first)}")
print(f"Starts with ---: {first[:3] == b'---'}")
